...
import type { GeneralGinPrintReportLine } from "./general-gin-print-report.types";
import { useApparelProTable } from "../../../../themes/useApparelProTable";

interface Props {
  data: GeneralGinPrintReportLine[];
  isLoading: boolean;
  isError: boolean;
}

export default function GeneralGinPrintReportGrid({
  data,
  isLoading,
  isError,
}: Props) {
  ...
  const table = useApparelProTable<GeneralGinPrintReportLine>({
    columns,
    data,
