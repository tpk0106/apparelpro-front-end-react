...
import type { GeneralSrtnPrintReportLine } from "./general-srtn-print-report.types";
import { useApparelProTable } from "../../../../themes/useApparelProTable";

interface Props {
  data: GeneralSrtnPrintReportLine[];
  isLoading: boolean;
  isError: boolean;
}

export default function GeneralSrtnPrintReportGrid({
  data,
  isLoading,
  isError,
}: Props) {
  ...
  const table = useApparelProTable<GeneralSrtnPrintReportLine>({
    columns,
    data,
