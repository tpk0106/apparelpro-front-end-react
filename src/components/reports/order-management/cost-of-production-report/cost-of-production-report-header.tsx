...
interface CostOfProductionReportHeaderProps {
  onScopeLock: (scope: CostOfProductionReportScopeContext | null) => void;
}

// Buyer and Order are BOTH mandatory (OD_FCOST.PRG exits the screen if either is left
// empty) - same "scope lock" pattern as Order Detail Report / Shipment Status Report.
export default function CostOfProductionReportHeader({
  onScopeLock,
}: CostOfProductionReportHeaderProps) {
  ...
  return (
    ...
    >
      ...
      >
        Cost of Production - Selection Criteria
      </Typography>
