...
interface TrimSheetReportHeaderProps {
  ...
  // once every dropdown level has settled; null while incomplete.
  onScopeLock: (scope: TrimSheetReportScopeContext | null) => void;
}

// Same cascading Buyer -> Purchase Order -> Garment Type -> Style selector pattern
// already established for Stylewise Events / Approve Trim Sheet - kept as its own
// component per this module's convention of one self-contained header per feature,
// rather than sharing a single generic component across unrelated screens.
export default function TrimSheetReportHeader({
  ...
  return (
    ...
    >
      ...
      >
        Trim Sheet Report - Selection Criteria
      </Typography>
