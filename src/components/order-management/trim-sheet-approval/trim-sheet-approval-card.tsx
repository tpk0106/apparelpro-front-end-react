      ...
      <ConfirmDialog
        ...
        message={
          <>
            ...
            Consumption entry for standard users (only a Merchandising Manager,
            Merchandiser Manager, or Executive Director can edit afterwards) and
            enable Supplier PO raising for this style. This cannot be undone
            from this screen.
          </>
        }
